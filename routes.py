...
# from wiki.web import current_profiles
...
from wiki.web.usersDatabase import UserProfile
...
def user_create():
    ...
    if form.validate_on_submit():
        ...
        new_user.add_profile(form.name.data, form.fullName.data, form.email.data)
        current_users.add_user(form.name.data, form.password.data, True, 'student', None)
